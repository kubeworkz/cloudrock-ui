...
const validateUsername = (username: string) => {
  ...
  if (
    username.length >
    MAXIMUM_USERNAME_LENGTH - ENV.plugins.CLOUDROCK_FREEIPA.USERNAME_PREFIX.length
  ) {
    return translate(
  ...
  <>
    <div
      className={classNames('m-b-sm', {
        'input-group': ENV.plugins.CLOUDROCK_FREEIPA.USERNAME_PREFIX !== '',
      })}
    >
      {ENV.plugins.CLOUDROCK_FREEIPA.USERNAME_PREFIX && (
        <OverlayTrigger
          placement="top"
          overlay={
