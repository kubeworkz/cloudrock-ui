...
export interface PluginConfiguration {
  CLOUDROCK_SUPPORT: Partial<SupportConfiguration>;
  CLOUDROCK_AUTH_SAML2: Partial<SAML2AuthConfiguration>;
  CLOUDROCK_AUTH_SOCIAL: Partial<SocialAuthConfiguration>;
  CLOUDROCK_AUTH_VALIMO: Partial<ValimoAuthConfiguration>;
  CLOUDROCK_CORE: CoreConfiguration;
  CLOUDROCK_MARKETPLACE: MarketplaceConfiguration;
  CLOUDROCK_OPENSTACK: Partial<OpenStackConfiguration>;
  CLOUDROCK_OPENSTACK_TENANT: Partial<OpenStackTenantConfiguration>;
  CLOUDROCK_MARKETPLACE_OPENSTACK: Partial<MarketplaceOpenStackTenantConfiguration>;
  CLOUDROCK_RANCHER: RancherConfiguration;
  CLOUDROCK_VMWARE: Partial<VMWareConfiguration>;
  CLOUDROCK_FREEIPA: Partial<FreeIPAConfiguration>;
}
