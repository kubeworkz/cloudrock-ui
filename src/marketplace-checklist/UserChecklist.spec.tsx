...
import { actWait, updateWrapper } from '@cloudrock/core/testUtils';
import { Await } from '@cloudrock/core/types';
import { SET_TITLE } from '@cloudrock/navigation/title';
...
jest.mock('@cloudrock/core/EChart', () => ({
  EChart: jest.fn(() => null),
}));
