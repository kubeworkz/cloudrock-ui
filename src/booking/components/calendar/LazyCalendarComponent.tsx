...
import { removeWeekends } from '@cloudrock/booking/components/calendar/utils';
import { CURSOR_NOT_ALLOWED_CLASSNAME } from '@cloudrock/booking/constants';
