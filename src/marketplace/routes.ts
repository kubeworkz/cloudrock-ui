...
import { ANONYMOUS_LAYOUT_ROUTE_CONFIG } from '@cloudrock/marketplace/constants';

const SupportOfferingsContainer = lazyComponent(
  () =>
    import(
      /* webpackChunkName: "SupportOfferingsContainer" */ '@cloudrock/marketplace/offerings/support/SupportOfferingsContainer'
    ),
...
const ResourceDetailsPageForCustomer = lazyComponent(
  () =>
    import(
      /* webpackChunkName: "ResourceDetailsPageForCustomer" */ '@cloudrock/marketplace/resources/ResourceDetailsPageForCustomer'
    ),
...
const ResourceDetailsPageForServiceProvider = lazyComponent(
  () =>
    import(
      ...
      '@cloudrock/marketplace/resources/ResourceDetailsPageForServiceProvider'
    ),
...
const ResourceDetailsPageForProjectWorkspace = lazyComponent(
  () =>
    import(
      ...
      '@cloudrock/marketplace/resources/ResourceDetailsPageForProjectWorkspace'
    ),
