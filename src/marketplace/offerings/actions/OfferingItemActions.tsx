...
import { REMOTE_OFFERING_TYPE } from '@cloudrock/marketplace-remote/constants';
import { googleCalendarActions } from '@cloudrock/marketplace/offerings/actions/GoogleCalendarActions';
import {
  isVisible,
...
const RequestActionDialog = lazyComponent(
  () =>
    import(
      /* webpackChunkName: "RequestActionDialog" */ '@cloudrock/marketplace/offerings/actions/RequestActionDialog'
    ),
  'RequestActionDialog',
);
