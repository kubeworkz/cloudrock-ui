...
import { updateProviderOfferingConfirmationMessage } from '@cloudrock/marketplace/common/api';
import { EditConfirmationMessageFormContainer } from '@cloudrock/marketplace/offerings/actions/EditConfirmationMessageFormContainer';
