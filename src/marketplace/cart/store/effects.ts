...
import { CustomerCreateFormData } from '@cloudrock/customer/create/types';
import { translate } from '@cloudrock/i18n';
import { createFlow } from '@cloudrock/marketplace-flows/api';
import * as api from '@cloudrock/marketplace/common/api';
import { ProjectCreateFormData } from '@cloudrock/project/ProjectCreateForm';
import { showError, showSuccess } from '@cloudrock/store/notify';
import {
  SET_CURRENT_PROJECT,
  SET_CURRENT_CUSTOMER,
} from '@cloudrock/workspace/constants';
