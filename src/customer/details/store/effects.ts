...
import { SET_CURRENT_CUSTOMER } from '@cloudrock/workspace/constants';
import { checkIsOwner, getUser } from '@cloudrock/workspace/selectors';
...
const PendingReviewDialog = lazyComponent(
  () =>
    import(
      /* webpackChunkName: "PendingReviewDialog" */ '@cloudrock/customer/team/PendingReviewDialog'
    ),
  'PendingReviewDialog',
);
