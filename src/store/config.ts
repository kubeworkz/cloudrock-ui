import { ApplicationConfigurationOptions } from '@cloudrock/core/types';

import { RootState } from './reducers';

const INITIAL_STATE: ApplicationConfigurationOptions = null;

export const INIT_CONFIG = 'cloudrock/core/INIT_CONFIG';
...
export const getNativeNameVisible = (state: RootState) =>
  state.config.plugins.CLOUDROCK_CORE.NATIVE_NAME_ENABLED === true;
