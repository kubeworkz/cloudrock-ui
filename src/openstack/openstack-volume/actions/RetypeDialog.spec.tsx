...
import { updateWrapper } from '@cloudrock/core/testUtils';
import * as api from '@cloudrock/openstack/api';
import { VolumeType } from '@cloudrock/openstack/types';
import { createActionStore } from '@cloudrock/resource/actions/testUtils';
import { Volume } from '@cloudrock/resource/types';

import { RetypeDialog } from './RetypeDialog';

jest.mock('@cloudrock/openstack/api');
