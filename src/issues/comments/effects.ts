...
import { issueAttachmentsDelete } from '@cloudrock/issues/attachments/actions';
import {
  ISSUE_ATTACHMENTS_PUT_START,
  ISSUE_ATTACHMENTS_PUT_SUCCESS,
  ISSUE_ATTACHMENTS_PUT_ERROR,
  ISSUE_ATTACHMENTS_PUT_REJECT,
} from '@cloudrock/issues/attachments/constants';
import { getUploading } from '@cloudrock/issues/attachments/selectors';
